...
router.get('/', function (req, res, next) {
    console.log("11")
    // 랭킹 1-10위 글
    return axios.get('http://localhost:4000/analysis/selectAnalysisPostList',{params: {"is_ranking_post" : 'y'}}, null)  
...
router.get('/profile', async function (req, res, next) {
    ...
    // 사용자 정보
    return await axios.get('http://localhost:4000/userInfo/selectUserInfo',{params: req.query}, null)  
    .then(async function (response) {
        userInfo.user_name = response.data.userInfo.user_name;
        
        // 사용자 블록체인 정보
        await axios.get('http://localhost:4000/userInfo/selectAddrAmountUsingAddr',{params: req.query}, null)  
        .then(async function (response) {
            userInfo.account_info = response.data.accountInfo
            
            // 사용자가 작성한 모든 글
            await axios.get('http://localhost:4000/userInfo/selectAllPost',{params: req.query}, null)  
            .then(async function (response) {
...
router.get('/community', function (req, res, next) {
    ...
    return axios.get('http://localhost:4000/analysis/selectAnalysisPostList',{params: req.query}, null)  
    .then(function (response) {
        console.log(response.data.analysis_post_list);
...
router.get('/post_1', function (req, res, next) {
    ...
    return axios.get('http://localhost:4000/forecast/selectForecastPostDetail',{params: req.query}, null)  
    .then(function (response) {
...
router.get('/post_2', function (req, res, next) {
    ...
    return axios.get('http://localhost:4000/communicationOperation/selectCommunityOperationPostDetail',{params: req.query}, null)  
    .then(function (response) {
...
router.get('/post_3', function (req, res, next) {
    ...
    return axios.get('http://localhost:4000/analysis/selectAnalysisPostDetail',{params: req.query}, null)  
    .then(function (response) {
...
router.get('/vote_dao_active', function (req, res, next) {
    ...
    return axios.get('http://localhost:4000/communicationOperation/selectCommunityOperationPostList',{params: req.query}, null)  
    .then(function (response) {
...
router.get('/vote_stock_active', function (req, res, next) {
    ...
    return axios.get('http://localhost:4000/forecast/selectForecastPostList',{params: req.query}, null)  
    .then(function (response) {
